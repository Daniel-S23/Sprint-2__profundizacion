...
const countries = ['Aeropuerto El Dorado', 'Aeropuerto José María'];
const countriesDestination = ['Seleccione un destino',
    'Alemania', 'Argentina', 'Estados Unidos', 'Mexico', 'Suiza', 'Uruguay', 'Holanda', 'Brasil', 'Rusia'];
